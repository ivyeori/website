...
<main className="relative h-screen overflow-hidden font-mono bg-slate-900 ">
    ...
    <header className="z-30 flex items-center w-full h-24 sm:h-32">
        <div className="container flex items-center justify-between px-6 mx-auto">
            <div className="flex items-center text-3xl font-black text-white uppercase dark:text-white">
                ...
                <a href="mailto:mail@getalex.info" className=" hover:underline mt-1 ml-3 text-xs">
    ...
    <div className="relative z-20 flex items-center">
        <div className="container relative flex flex-col items-center justify-between px-6 py-4 mx-auto">
            <div className="flex flex-col">
                ...
                <h2 className="max-w-3xl py-2 mx-auto text-5xl font-bold text-center text-white md:text-6xl dark:text-white">
