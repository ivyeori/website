...
<main class="relative h-screen overflow-hidden font-mono bg-slate-900 ">
    <div class="absolute hidden md:block -bottom-32 -left-32 w-96 h-96">
        <div class="absolute z-20 text-xl text-extrabold right-14 text-start top-1/4">
            <span class="text-7xl">
            💻
            </span>
            <p>
            ...
            <a href="https://t.me/ivyeori" class="underline">
                Let&#x27;s talk
            </a>
        </div>
    ...
    <header class="z-30 flex items-center w-full h-24 sm:h-32">
        <div class="container flex items-center justify-between px-6 mx-auto">
            <div class="flex items-center text-3xl font-black text-white uppercase dark:text-white">
    ...
    <div class="relative z-20 flex items-center">
        <div class="container relative flex flex-col items-center justify-between px-6 py-4 mx-auto">
            <div class="flex flex-col">
                <img src="https://imgur.com/vqyGsdc.jpg" class="mx-auto rounded-full w-28"/>
                <p class="my-6 text-3xl text-center text-white ">
                    Hi, I&#x27;m Alex
                </p>
                <h2 class="max-w-3xl py-2 mx-auto text-5xl font-bold text-center text-white md:text-6xl dark:text-white">
                    Building websites, programs, and experiences.
                </h2>
                <div class="flex items-center justify-center mt-4">
                    <a href="https://beacons.ai/ivyeori" target="_blank" class="px-4 py-2 my-2 text-white uppercase bg-transparent border-2 border-gray-800 md:mt-16 dark:text-white dark:bg-white hover:dark:bg-gray-100 dark:text-white hover:bg-gray-800 hover:text-white text-md">
                        CONNECT WITH ME
                    </a>
                </div>
            </div>
